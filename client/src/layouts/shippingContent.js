...
const ShippingContent = () => {
  return (
    <div style={{ padding: "2em" }}>
      ...
      demand products. Our standard shipping method is ground shipping. We will
      ship your order via any of the major mail carriers, including India Post
      services. At this time, we are unable to provide the option to choose your
      carrier of choice. Usually, all our orders are delivered within 5-7
      business days unless there are any unforeseen climate issues.
    </div>
  );
};
