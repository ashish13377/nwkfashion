      ...
      <div className="card-inner p-0">
        <ul className="link-list-menu">
          <li onClick={() => updateSm(false)}>
            <Link
              to={`/admin/user-profile-regular`}
              className={window.location.pathname === `/admin/user-profile-regular` ? "active" : ""}
            >
          ...
          <li onClick={() => updateSm(false)}>
            <Link
              to={`/admin/user-profile-notification`}
              className={window.location.pathname === `/admin/user-profile-notification` ? "active" : ""}
            >
          ...
          <li onClick={() => updateSm(false)}>
            <Link
              to={`/admin/user-profile-activity`}
              className={window.location.pathname === `/admin/user-profile-activity` ? "active" : ""}
            >
          ...
          <li onClick={() => updateSm(false)}>
            <Link
              to={`/admin/user-profile-setting`}
              className={window.location.pathname === `/admin/user-profile-setting` ? "active" : ""}
            >
